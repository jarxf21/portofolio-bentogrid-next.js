...
export function BentoGrid({ profile }: BentoGridProps) {
    return (
        ...
        >
            ...
            <div className="sticky top-0 h-screen w-full flex items-center justify-center px-4 py-12 bg-primary-100">
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <motion.h1
                                    ...
                                    className="text-4xl md:text-5xl font-bold leading-tight mb-4 text-primary-950"
                                >
                                    Hey, I'm<br />
                                ...
                                <motion.p
                                    ...
                                    className="text-primary-950 text-lg font-medium mb-8"
                                >
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <motion.h1
                                    ...
                                    className="text-5xl lg:text-6xl font-bold leading-tight mb-4 text-primary-950"
                                >
                                    Hey, I'm<br />
                                    <span className="text-primary-950">{profile?.fullName || 'Full Stack Engineer'}</span>
                                </motion.h1>
                                ...
                                <motion.p
                                    ...
                                    className="text-primary-950 text-xl font-medium mb-8 max-w-lg"
                                >
                                    {profile?.headline || 'Building scalable web apps with natural UX'}
                                </motion.p>
                            </div>
